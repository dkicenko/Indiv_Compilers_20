...
namespace SimpleLang.Visitors
{
    public class GenCodeVisitor: Visitor
    {
        ...
        {
            Label f = genc.DefineLabel();
            Label end = genc.DefineLabel();
            n.expr.Visit(this);
            genc.Emit(OpCodes.Brfalse, f);
            n.ifTrue.Visit(this);
            genc.Emit(OpCodes.Br, end);
            genc.MarkLabel(f);
            if (n.ifFalse != null) 
                n.ifFalse.Visit(this);
            genc.MarkLabel(end);
        ...
        public override void VisitRepeatNode(RepeatNode n)
        {
            Label start = genc.DefineLabel();
            Label end = genc.DefineLabel();
            genc.MarkLabel(start);
            n.stat.Visit(this);
            n.expr.Visit(this);
            genc.Emit(OpCodes.Brtrue, start);
